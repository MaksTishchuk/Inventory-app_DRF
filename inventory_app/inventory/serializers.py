...
from my_user.serializers import CustomUserSerializer


class InventoryGroupSerializer(serializers.ModelSerializer):
    """ Сериализатор групп инвентаря """
...
class InventoryWithSumSerializer(InventorySerializer):
    """ Сериализатор инвентаря с дополнительным полем суммы для представления """
...
class ShopWithAmountSerializer(ShopSerializer):
    """ Сериализатор магазина с дополнительным полем информации о продажах """
...
class InvoiceItemSerializer(serializers.ModelSerializer):
    """ Сериализатор инвентаря из счета """
...
class InvoiceItemDataSerializer(serializers.Serializer):
    """ Сериализатор данных инвентаря из счета """
